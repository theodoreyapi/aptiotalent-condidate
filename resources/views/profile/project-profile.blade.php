                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Titre du projet</h5>
                                            <p>Oui / Non</p>
                                        </td>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Rôle</h5>
                                            <p>Yapi</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Lien projet</h5>
                                            <a href="#" target="_blank">lien</a>
                                        </td>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Début du projet</h5>
                                            <p>Yapi</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Travaille sur le projet</h5>
                                            <p>Oui / Non</p>
                                        </td>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Description</h5>
                                            <p>M.</p>
                                        </td>
                                    </tr>
                                </tbody>
