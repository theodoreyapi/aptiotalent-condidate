                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Entreprise actuelle</h5>
                                            <p>Oui / Non</p>
                                        </td>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Type d'emploi</h5>
                                            <p>Yapi</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Titre de poste</h5>
                                            <p>M.</p>
                                        </td>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Experience</h5>
                                            <p>Yapi</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Nom entreprise</h5>
                                            <p>M.</p>
                                        </td>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Date d'entrée en fonction</h5>
                                            <p>Yapi</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Délais de préavis</h5>
                                            <p>Yapi</p>
                                        </td>
                                    </tr>
                                </tbody>
