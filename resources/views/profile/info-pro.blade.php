                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Secteur d'activité actuel</h5>
                                            <p>M.</p>
                                        </td>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Département actuel</h5>
                                            <p>Yapi</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Catégorie du rôle actuel</h5>
                                            <p>M.</p>
                                        </td>
                                        <td class="ps-0">
                                            <h5 class="mb-1 fw-medium">Fonction actuelle</h5>
                                            <p>Yapi</p>
                                        </td>
                                    </tr>
                                </tbody>
